...
class MediasetController extends Controller {
    ...
    private function baseUrl(string $channel = null): string {
        //    return "https://live2.msf.cdn.mediaset.net/content/hls_h0_clr_vos/live/channel(#channel)";

        if (in_array($channel, ["r101", "radio-105"])) {
            return "https://live02-seg.msr.cdn.mediaset.net/live/ch-#channel/#channel-clr.isml/index.m3u8";
        }
